...
class NumericalPsystem(object):
    ...
    def simulate(self, stepByStepConfirm = False, maxSteps = -1, maxTime = -1):
        ...
        logging.info("Simulation finished succesfully after %d steps ; End state below:" % (currentStep))
...
def tokenize(code):
    ...
    token_specification = [
        ...
        ('FUNCTION_MIN', r'min'),  # base 2 logarithm function
